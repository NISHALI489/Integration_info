...
Task assigned in jira for integration. As per your zonal check your task and clone NB(Nightly build) full project folder tak into your local pc. if bench PC use jfrog
